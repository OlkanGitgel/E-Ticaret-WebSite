...
<%--    <form id="frm" runat="server">--%>
      ...
      <div class="breadcrumb"> <a href="default.aspx">AnaSayfa</a> » <a href="#"><%#Eval("UrunAdi") %></a></div>
      <!--Breadcrumb Part End-->
      <div class="product-info">
        <div class="left">
          <div class="image"> <a href="urunresimleri/600/<%#Eval("FotoYol") %>" title="iPhone" class="cloud-zoom colorbox" id='zoom1' rel="adjustX: 0, adjustY:-350, tint:'#000000',tintOpacity:0.2, zoomWidth:360, position:'outside', zoomOffsetX: 3, showTitle:false"> <img src="urunresimleri/350/<%#Eval("FotoYol") %>" title="#" alt="#" id="image" /><span></span></a> </div>
...
<a href="urunresimleri/350/<%#Eval("FotoYol") %>" title="#" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: 'urunresimleri/350/<%#Eval("FotoYol") %>' "> <img src="urunresimleri/152/<%#Eval("FotoYol") %>" width="62" title="#" alt="#" /></a>
        ...
        <div class="right">
          ...
          <div class="cart">
            <div>
              ...
              <asp:LinkButton ID="LinkButton1" runat="server" CssClass="button" CommandName="sepeteat" CommandArgument='<%#Eval("UrunID") %>'>Sepet</asp:LinkButton>
            </div>
      ...
      <div class="tab-content" id="tab-review">
          ...
          <div class="author"><b><%#Eval("UserName") %></b> on  <%# string.Format("{0:MM/dd/yyyy}", Eval("Tarih").ToString().Substring(0,10)) %></div>
