<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="sepet.aspx.cs" Inherits="sepet" EnableEventValidation="false" %>
                        ...
                        <asp:Repeater ID="rpSepet" runat="server" OnItemCommand="rpSepet_ItemCommand" >
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td class="quantity">
                                        <input id="quantity" name="quantity" type="text" size="1" value="<%#Eval("adet") %>" name="<%#Eval("id") %>" class="w30">
                                        &nbsp;<asp:ImageButton ID="btnUpdate" runat="server" CommandName="guncelle" CommandArgument='<%#Eval("id") %>' ImageUrl="~/image/update.png" />
                 <asp:ImageButton ID="btnDelete" runat="server" CommandName="sil" CommandArgument='<%#Eval("id") %>' ImageUrl="~/image/remove.png" />
