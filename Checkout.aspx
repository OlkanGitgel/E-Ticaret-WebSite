    ...
    <div id="content">
        ...
        <div class="checkout">
            <asp:LoginView ID="LoginView1" runat="server">
                ...
                <LoggedInTemplate>
                    <div class="checkout">
                        <div class="checkout-heading">Shipping Details</div>
                        <div class="checkout-content">
                            <table class="form">
                                ...
                                <tbody>
                                    <asp:Repeater ID="rpAdres" runat="server" OnItemCommand="rpAdres_ItemCommand" OnItemDataBound="rpAdres_ItemDataBound">
                                        <ItemTemplate>
                                            <tr>
                                                <td><%#Eval("Isim") %></td>
                                                <td>
                                                    <asp:RadioButton ID="rbSec" runat="server" Text='<%#Eval("Isim") %>' /></td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </tbody>
